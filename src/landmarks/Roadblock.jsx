      ...
      <main className="full-height">
        <div className="container pt-5">
          <div className="alert alert-light alert-roadblock" role="alert">
            A user ID and business unit must be provided before continuing.
            <svg className="bi bi-alert-octagon" width="1em" height="1em" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
